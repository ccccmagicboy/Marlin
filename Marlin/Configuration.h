 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 40, 40, 40, 40 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 40, 40, 40, 40 } // ...or, set your own edit limits
#endif
...
#define Z_AFTER_HOMING  180      // (mm) Height to move to after homing Z
...
#define OLED_KIT_MEEB3DP
#if ENABLED(OLED_KIT_MEEB3DP)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 42       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
